...
use configuration::base::initialization_configuration_manager::InitializationConfigurationManager;
use log::info;
use std::sync::Arc;
use utoipa::OpenApi;
...
use crate::services::backends::load_backend;
use crate::services::external_identity_validator_provider::ExternalIdentityValidatorProvider;
use crate::services::token_provider::encrypted_token_provider::EncryptedTokenProvider;
use anyhow::Result;
...
use configuration::models::AppSettings;
...
async fn main() -> Result<()> {
    ...
    let token_provider = Arc::new(EncryptedTokenProvider::new(
